                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-5">
                    ...
                    <FormField
                      ...
                      render={({ field }) => {
                        const selectedCategory = category?.data?.find(
                          (cat: Category) => cat._id === field.value
                        );
                        return (
                          <FormItem>
                            <FormLabel className="text-sm font-semibold text-gray-700">
                            ...
                            >
                              <FormControl>
                                <SelectTrigger className="h-12 w-full border-gray-300 focus:border-red-500 focus:ring-red-500">
                    ...
                    <FormField
                      ...
                      name="subCategoryId"
                      render={({ field }) => {
                        const selectedSubCategory = subcategory?.data?.find(
                          (sub: SubCategory) => sub._id === field.value
                        );
                        return (
                          <FormItem>
                            <FormLabel className="text-sm font-semibold text-gray-700">
